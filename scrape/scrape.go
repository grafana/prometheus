...
func newScrapePool(cfg *config.ScrapeConfig, app storage.Appendable, jitterSeed uint64, logger log.Logger, reportScrapeTimeout bool, dialFunc config_util.DialContextFunc) (*scrapePool, error) {
